                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <b>Selamat Datang di Perpustakaan PENS, Untuk Login silahkan klik Icon User atau klik <a href="login.html">disini</a></b>
                        </div>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Perpustakaan PENS</h4>
                </div>
                <div class="modal-body">
                    <p> Perpustakaan PENS adalah salah satu layanan bagi pengguna untuk dapat mengakses berbagai buku bacaan yang dan dilakukan kapan saja dan dari mana saja, dengan menggunakan jaringan internet.</p>
                    <p> Perpustakaan PENS memiliki koleksi buku dalam bentuk format digital dan bisa diakses dengan komputer. koleksi bacaan dari Perpustakaan PENS dapat diakses dengan cepat dan mudah lewat jaringan komputer.</p>
                    <p> Perpustakaan PENS bebasis website yang responsif, untuk info, saran, maupun kritik bisa menghubungi kami :</p>
                    <table>
                        <tr>
                            <td>E-mail</td>
                            <td>:</td>
                            <td><a href="https://mail.google.com/mail/u/0/#inbox?compose=CllgCJqTfrDgpPTPqbjKBLDZVxstfKmqWgpflxWLgNJWRcTTSpfVxPJZnHDNHFmJjkPDlBLPFVB">perpustakaanpens@gmail.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Blog</td>
                            <td>:</td>
                            <td><a href="#" target="_blank">www.PerpustakaanPENS.com</a></td>
                        </tr>
                        <br />
                        <tr>
                            <td>Website</td>
