...
$query = mysqli_query($conn, "INSERT INTO pengunjung ( nama, jk, kelas, perlu1, cari, saran, tgl_kunjung, jam_kunjung) VALUES ( '$nama', '$jk', '$kelas', '$perlu1', '$cari', '$saran', '$tgl_kunjung', '$jam_kunjung')");
if ($query){
